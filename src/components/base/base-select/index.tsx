  ...
  const renderSelectedValue = () => {
    ...
    if (multiple)
      return selectedValue?.length ? (
        <div className="flex items-center justify-between text-gray-medium">
          ...
          <>
            ...
            <div className="relative h-full">
              ...
              >
                ...
                {isLoading && (
                  <BaseSelectLeadingIcon icon={LoadingSpinner as any} />
                )}
                ...
                {options?.length ? (
                  <Listbox.Options
                    className={parseClassNames(
                      ...
                      "ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none  transition-transform ease-out",
